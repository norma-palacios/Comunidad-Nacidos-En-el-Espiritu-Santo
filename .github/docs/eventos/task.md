...
[x] Paso 1: Especificación (features/eventos/EventCard.feature)

[x] Paso 2: Prueba (src/components/features/eventos/__tests__/EventCard.spec.jsx)

[x] Paso 3: Componente (src/components/features/eventos/EventCard.jsx)
...
[x] Paso 1: Especificación (features/eventos/EventFilter.feature)

[x] Paso 2: Prueba (src/components/features/eventos/__tests__/EventFilter.spec.jsx)

[x] Paso 3: Componente (src/components/features/eventos/EventFilter.jsx)
...
[x] Paso 1: Especificación (features/eventos/EventList.feature)

[x] Paso 2: Prueba (src/components/features/eventos/__tests__/EventList.spec.jsx)

[x] Paso 3: Componente (src/components/features/eventos/EventList.jsx)
...
[x] Paso 1: Especificación (features/eventos/EventPage.feature)

[x] Paso 2: Prueba (src/app/eventos/__tests__/page.spec.jsx)

[x] Paso 3: Componente (src/app/eventos/page.jsx)
